...
void main() {
    // [FIX v0.2.3] texture2D -> texture throughout main()
    ...
    if (isOverworld) {
        ...
        if (mistTimeFactor > 0.01 && mistDensityFactor > 0.01) {
            ...
            float lowSunWarmth = sunsetFactor * dayFactor * (1.0 - rainStrength) * 0.24;
    ...
    if (isOverworld) {
        ...
        if (camMistDensity > 0.01 && camMistTime > 0.01) {
            ...
            float lowSunWarmth = sunsetFactor * dayFactor * (1.0 - rainStrength) * 0.18;
