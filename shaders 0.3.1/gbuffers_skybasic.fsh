...
// [v0.3.2] Falling stars (meteors / shooting stars) crossing the night sky.
...
// ==============================================================================
// [v0.3.2] PHYSICALLY-BASED METEORS (Falling Stars)
// ==============================================================================
...
vec2 greatCircleDistance(vec3 viewDir, vec3 pA, vec3 pB) {
    ...
    vec3 proj = normalize(viewDir - N * dot(viewDir, N));
...
void main() {
    ...
    if (isOverworld) {
        ...
        // [v0.3.2] Physically-based meteors. Visible at night, dimmed by
        ...
        // [v0.3.2] Meteors in the End — eternal night, no moon, no atmosphere
