...
// [v0.2.9.3] colortex6 output removed — final.fsh now reads normals directly
...
void main() {
    ...
    if (depth < 1.0 && isEmissive > 0.5) {
        ...
        // [v0.2.9.3] colortex6 write removed
        return;
    }
    ...
    // [v0.2.9.3] SSR data export removed. final.fsh now reads normals from
