...
// AuraLite Shaders v1.0.0 - Copyright (c) 2026 AlexanderNyr. Licensed under CC BY-NC-SA 4.0.
...
// [v1.0.0] colortex6 output removed — final.fsh now reads normals directly
...
void main() {
    ...
    if (depth < 1.0 && isEmissive > 0.5) {
        ...
        // [v1.0.0] colortex6 write removed
        return;
    }
    ...
    // [v1.0.0] SSR data export removed. final.fsh now reads normals from
