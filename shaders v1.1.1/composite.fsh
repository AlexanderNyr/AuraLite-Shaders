...
const float shadowDistance = 80.0;    // [60.0 80.0 120.0 160.0] - [v1.1.1] Real shadow pass radius in blocks
const float shadowDistanceRenderMul = 1.0; // v1.1.1: Cull shadow pass geometry outside shadowDistance
...
void main() {
    ...
    if (isOverworld) {
        ...
        float distBias = 0.00010 * smoothstep(52.0, shadowDistance, terrainDist);
