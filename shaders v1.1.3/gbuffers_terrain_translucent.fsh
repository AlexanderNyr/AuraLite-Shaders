...
void main() {
    ...
    // [FIX v1.1.3] Same navy-tint floor as gbuffers_water.fsh: frozen-ocean
    // tints (e.g. 0x3938C9) crushed R/G to black after pow(albedo, 2.2).
    // Pin R/G >= 0.16/0.34 of B; neutral ocean and swamp tints unaffected.
